...
async fn test_pyth() -> Result<()> {
    ...
    check!(burrowland_contract.add_token_pyth_info(&root, linear_contract.0.id(), 24, 4, "27e867f0f4f61076456d1a73b14c7edc1cf5cef4f4d6193a33424288f11bd0f4", Some(EXTRA_CALL_FT_PRICE.to_string())));
    ...
    // stnear
    let current_timestamp = worker.view_block().await?.timestamp();
    check!(burrowland_contract.add_token_pyth_info(&root, stnear_contract.0.id(), 24, 4, "27e867f0f4f61076456d1a73b14c7edc1cf5cef4f4d6193a33424288f11bd0f4", Some(EXTRA_CALL_GET_ST_NEAR_PRICE.to_string())));
    check!(pyth_contract.set_price("27e867f0f4f61076456d1a73b14c7edc1cf5cef4f4d6193a33424288f11bd0f4", PythPrice{
        price: I64(278100000),
        conf: U64(278100),
        expo: -8,
    ...
    // nearx
    let current_timestamp = worker.view_block().await?.timestamp();
    check!(burrowland_contract.add_token_pyth_info(&root, nearx_contract.0.id(), 24, 4, "27e867f0f4f61076456d1a73b14c7edc1cf5cef4f4d6193a33424288f11bd0f4", Some(EXTRA_CALL_GET_NEARX_PRICE.to_string())));
    check!(pyth_contract.set_price("27e867f0f4f61076456d1a73b14c7edc1cf5cef4f4d6193a33424288f11bd0f4", PythPrice{
        price: I64(278100000),
        conf: U64(278100),
        expo: -8,
    ...
    // dai
    let current_timestamp = worker.view_block().await?.timestamp();
    check!(burrowland_contract.add_token_pyth_info(&root, dai_token_contract.0.id(), 18, 4, "87a67534df591d2dd5ec577ab3c75668a8e3d35e92e27bf29d9e2e52df8de412", None));
...
async fn test_liquidation_decrease_health_factor_with_pyth() -> Result<()> {
    ...
    // usdt
    let current_timestamp = worker.view_block().await?.timestamp();
    check!(burrowland_contract.add_token_pyth_info(&root, nusdt_token_contract.0.id(), 6, 4, "1fc18861232290221461220bd4e2acd1dcdfbc89c84092c93c18bdc7756c1588", None));
    check!(pyth_contract.set_price("1fc18861232290221461220bd4e2acd1dcdfbc89c84092c93c18bdc7756c1588", PythPrice{
        price: I64(100000000),
        conf: U64(103853),
        expo: -8,
...
async fn test_force_close_with_pyth() -> Result<()> {
   ...
   // usdc
   let current_timestamp = worker.view_block().await?.timestamp();
   check!(burrowland_contract.add_token_pyth_info(&root, nusdc_token_contract.0.id(), 6, 4, "1fc18861232290221461220bd4e2acd1dcdfbc89c84092c93c18bdc7756c1588", None));
   check!(pyth_contract.set_price("1fc18861232290221461220bd4e2acd1dcdfbc89c84092c93c18bdc7756c1588", PythPrice{
       price: I64(100000000),
       conf: U64(103853),
       expo: -8,
