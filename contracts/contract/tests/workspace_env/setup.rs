...
const PREVIOUS_BURROWLAND_WASM: &str = "../../releases/burrowland_0.7.0.wasm";
    ...
    assert!(burrowland.call("new")
        .args_json(json!({
            "config": Config {
                ...
                // ref_exchange_account_id: near_sdk::AccountId::new_unchecked("ref_exchange.test.near".to_string()),
